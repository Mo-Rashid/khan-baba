...
export default function SystemPromptLeakLab() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "bot",
      text: "Hello! I am a secure assistant. How can I help you today?",
    },
  ]);
  ...
  const [reviews, setReviews] = useState(() => {
    try {
      const saved = localStorage.getItem("spl_lab_reviews");
  ...
  const sendPrompt = async () => {
    ...
    try {
      ...
      console.error("System Prompt Leak API Error:", error);
      setMessages((prev) => [
        ...prev,
        {
          role: "bot",
  ...
  const changeChallenge = (id) => {
    ...
    setMessages([
      {
        role: "bot",
        text: `Challenge ${id}: ${challenges[id - 1].title}. Try to extract the hidden system prompt.`,
      },
    ]);
  };
  ...
  const submitReview = () => {
    ...
    localStorage.setItem("spl_lab_reviews", JSON.stringify(newReviews));
      ...
      <div className="customer-page">
        ...
        <main className="api-page">
          <div className="api-card">
            ...
            <div className="api-kicker">SYSTEM PROMPT LEAK LAB</div>
  ...
  const LAB_KEY = "ai-system-prompt-leak";
    ...
    <div className="customer-page">
      ...
      <main className="customer-container">
        ...
        <section className="customer-hero">
          <div className="hero-kicker">AI SECURITY / SYSTEM PROMPT LEAK</div>
          <h1>
            SYSTEM PROMPT
            <span> LEAK LAB</span>
          </h1>
          <p>
            Extract hidden system prompts and secret flags from a protected AI
            assistant through prompt extraction techniques.
          </p>
          ...
          <div className="lab-content">
            <div className="content-heading">
              <div>
                ...
                <h2>{current.title}</h2>
                <p>
                  Attempt to extract the hidden system prompt and secret flag
                  from the protected assistant.
                </p>
              </div>
            ...
            <div className="mission-card">
              ...
              <div className="mission-body">
                ...
                <p>
                  Extract the hidden system prompt or secret flag using prompt
                  extraction, override, encoding, or role-play techniques.
                </p>
              </div>
            </div>
            ...
            <div className="chat-card">
              <div className="chat-header">
                ...
                <div>
                  ...
                  <span>System Prompt Protection Lab</span>
                </div>
