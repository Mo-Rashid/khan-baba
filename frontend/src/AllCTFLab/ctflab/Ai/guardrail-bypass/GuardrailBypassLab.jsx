...
const challenges = [
  ...
  {
    id: 5,
    title: "Advanced Guardrail Bypass",
    type: "ADVANCED",
    difficulty: "Hard",
    points: 300,
  },
...
export default function GuardrailBypassLab() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "bot",
      text: "Hello! I am a filtered assistant. Some words are blocked by safety guardrails. How can I help you?",
    },
  ]);
  ...
  const [reviews, setReviews] = useState(() => {
    try {
      const saved = localStorage.getItem("gb_lab_reviews");
  ...
  const sendPrompt = async () => {
    ...
    try {
      ...
      console.error("Guardrail Bypass API Error:", error);
      setMessages((prev) => [
        ...prev,
        {
          role: "bot",
  ...
  const changeChallenge = (id) => {
    ...
    setMessages([
      {
        role: "bot",
        text: `Challenge ${id}: ${challenges[id - 1].title}. Try to bypass the safety guardrails.`,
      },
    ]);
  };
  ...
  const submitReview = () => {
    ...
    localStorage.setItem("gb_lab_reviews", JSON.stringify(newReviews));
      ...
      <div className="customer-page">
        ...
        <main className="api-page">
          <div className="api-card">
            ...
            <div className="api-kicker">GUARDRAIL BYPASS LAB</div>
  ...
  const LAB_KEY = "ai-guardrail-bypass";
    ...
    <div className="customer-page">
      ...
      <main className="customer-container">
        <section className="customer-hero">
          <div className="hero-kicker">AI SECURITY / GUARDRAIL BYPASS</div>
          <h1>
            GUARDRAIL
            <span> BYPASS LAB</span>
          </h1>
          <p>
            Bypass keyword filters, encoding checks, split-payload detection,
            and multi-layer safety guardrails.
          </p>
          ...
          <div className="lab-content">
            <div className="content-heading">
              <div>
                ...
                <h2>{current.title}</h2>
                <p>
                  Bypass the active safety guardrails and extract the hidden
                  training secret.
                </p>
              </div>
            ...
            <div className="mission-card">
              ...
              <div className="mission-body">
                ...
                <p>
                  Use keyword tricks, encoding, payload splitting, role-play, or
                  combined techniques to bypass guardrails and capture the flag.
                </p>
              </div>
            </div>
            ...
            <div className="chat-card">
              <div className="chat-header">
                ...
                <div>
                  ...
                  <span>Controlled guardrail bypass training environment</span>
                </div>
                ...
                <div className="chat-screen">
                  ...
                  <div className="chat-input-area">
                    <textarea
                      ...
                      placeholder="Try to bypass the filter... e.g. encode or split your payload"
                      disabled={loading}
                    />
                    <button
                      onClick={sendPrompt}
