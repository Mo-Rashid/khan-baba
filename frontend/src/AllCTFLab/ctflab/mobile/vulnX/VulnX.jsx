...
/*
=========================================================
VULNX — SINGLE ANDROID APK SECURITY LAB
=========================================================
*/
...
const LAB = {
  ...
  points: 150,
  description:
    "Analyze the VulnX Android APK and identify the hardcoded security challenge flag.",
  objective:
...
const VulnX = () => {
  ...
  const [completed, setCompleted] = useState(() => {
    try {
      return (
        localStorage.getItem("VulnXploit-vulnx-progress") === "completed"
      );
    } catch {
      return false;
    }
  ...
  const downloadAPK = () => {
    ...
    const downloadURL = "/images/apk/Vuln-Lab.apk";
  ...
  const resetProgress = () => {
    try {
      localStorage.removeItem("VulnXploit-vulnx-progress");
    } catch {}
  ...
  return (
    <div className="apk-lab-page">
      ...
      <section className="apk-hero">
        ...
        <p>
          Analyze the VulnX Android APK through a hands-on mobile security
          challenge and discover the hidden flag.
        </p>
            ...
            <>
              <div className="ctf-card">
                <div className="card-title">
                  ...
                  <div>
                    ...
                    <span>VulnX Android Application</span>
                  </div>
                </div>
              ...
              <div className="ctf-card">
                ...
                <div className="objective-content">
                  ...
                  <p>
                    Enter the flag discovered during your VulnX APK analysis.
