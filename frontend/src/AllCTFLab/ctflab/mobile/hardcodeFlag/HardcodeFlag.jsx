...
import "./HardcodeFlag.css";

/*
=========================================================
HARDCODE FLAG — SINGLE ANDROID APK SECURITY LAB
=========================================================
*/
...
const LAB = {
  ...
  points: 150,
  description:
    "Analyze the Hardcode Flag Android APK and identify the hardcoded security challenge flag.",
  objective:
    "Download the provided APK, perform authorized local Android security analysis, locate the hardcoded challenge flag, and submit it for verification.",
  hint: "Start with static APK analysis. Inspect AndroidManifest.xml, resources, strings, assets and decompiled source code for hardcoded secrets.",
  apkName: "hard-labs.apk",
};
...
const HardcodeFlag = () => {
  ...
  const [completed, setCompleted] = useState(() => {
    try {
      return (
        localStorage.getItem("VulnXploit-hardcodeflag-progress") ===
        "completed"
      );
    } catch {
      return false;
  ...
  useEffect(() => {
    try {
      localStorage.setItem(
        "VulnXploit-hardcodeflag-progress",
  ...
  const downloadAPK = () => {
    ...
    const downloadURL = "/images/apk/hard-labs.apk";
  ...
  const resetProgress = () => {
    try {
      localStorage.removeItem("VulnXploit-hardcodeflag-progress");
    } catch {}
  ...
  return (
    <div className="apk-lab-page">
      ...
      <section className="apk-hero">
        ...
        <p>
          Analyze the HardcodeFlag Android APK through a hands-on mobile
          security challenge and discover the hidden flag.
        </p>
        ...
        <section className="challenge-area">
          ...
          {!labStarted && !completed ? (
            <div className="start-card">
              ...
              <p>
                This challenge contains one Android hardcoded-secret security
                layer. Start the lab to access the APK download and flag
            ...
            <>
              ...
              <div className="ctf-card">
                <div className="card-title">
                  ...
                  <div>
                    ...
                    <span>HardcodeFlag Android Application</span>
                  </div>
                </div>
              ...
              <div className="ctf-card">
                ...
                <div className="objective-content">
                  ...
                  <p>
                    Enter the flag discovered during your HardcodeFlag APK
